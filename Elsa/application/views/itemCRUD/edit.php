<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Edit Note No.<?php echo $item->noteId?></h2>
        </div>
...
<form method="post" action="<?php echo base_url('itemCRUD/update/'.$item->noteId);?>">
    <?php
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea name="description" class="form-control"><?php echo $item->Body; ?></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
